...
📖 **Get sharper reviews**: [how-to-get-the-most.md](how-to-get-the-most.md) — conventions, per-PR review briefs, and workflows that turn Baloo into a context-aware reviewer
...
| `REVIEW_AUTO_APPROVE`         | `false`                   | Auto-approve PRs with no blocking findings (opt-in)                |
...
- [How to Get the Most Out of Baloo](how-to-get-the-most.md) — Conventions, per-PR review briefs, high-signal workflows
...
- [Models](features/models.md) — Supported providers, models, and tiers
...
Baloo supports Anthropic, Amazon Bedrock, Google, and OpenAI providers. The selected provider applies to every agent. See [features/models.md](features/models.md).
